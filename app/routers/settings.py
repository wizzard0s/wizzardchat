...
SETTINGS_SCHEMA = [
    ...
    },
    {
        ...
        "fields": [
            {
                "key": "default_omni_max",
                "label": "Omni-Channel Max (total)",
                "description": "Maximum concurrent interactions an agent handles across all channels. Agent-level overrides take priority.",
                "type": "number",
                "default": "8",
                "min": 1,
                "max": 50,
            ...
            {
                "key": "default_channel_max_voice",
                "label": "Max Concurrent Voice Calls",
                "description": "Maximum simultaneous voice calls per agent. Typically 1.",
                "type": "number",
                "default": "1",
                "min": 1,
                "max": 10,
            ...
            {
                "key": "default_channel_max_chat",
                "label": "Max Concurrent Chat Sessions",
                "description": "Maximum simultaneous web/widget chat sessions per agent.",
                "type": "number",
                "default": "5",
                "min": 1,
                "max": 20,
            ...
            {
                "key": "default_channel_max_whatsapp",
                "label": "Max Concurrent WhatsApp Sessions",
                "description": "Maximum simultaneous WhatsApp conversations per agent.",
                "type": "number",
                "default": "3",
                "min": 1,
                "max": 20,
            ...
            {
                "key": "default_channel_max_email",
                "label": "Max Concurrent Email Threads",
                "description": "Maximum simultaneous email threads per agent.",
                "type": "number",
                "default": "5",
                "min": 1,
                "max": 20,
            ...
            {
                "key": "default_channel_max_sms",
                "label": "Max Concurrent SMS Threads",
                "description": "Maximum simultaneous SMS conversations per agent.",
                "type": "number",
                "default": "5",
                "min": 1,
                "max": 20,
